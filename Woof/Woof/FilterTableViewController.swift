...
class FilterTableViewController: UIViewController{
    ...
    let font = "Rubik"
    //origins
    let top_origin = CGPoint(x: 20, y: 130)
    let next_origin = CGPoint(x: 250, y: 80)
    ...
    //    @IBAction func about(_sender: UIButton!) {
    //        //let controller = (segue.destination as! UINavigationController).topViewController as!FilterResult
    //        let secondViewController:FilterResultViewController = FilterResultViewController()
    //        secondViewController.hair = self.hair
    ...
    //
    //
    //        performSegue(withIdentifier: "switch", sender: _sender)
    //    }
